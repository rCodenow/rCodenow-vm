...
class SecurityManager {
     ...
     */
    isCcx (extensionURL){
        if (extensionURL.indexOf("data:application/x-zip-compressed;base64,") !== -1 || extensionURL.indexOf("data:application/x-zip-compressed;base64,") !== -1){
            console.log('isccx')
            return true;
        }
        else{
            console.log('it isn\'t ccx')
            return false;
        }
    }
}
